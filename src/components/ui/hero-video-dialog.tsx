...
export default function HeroVideoDialog({
	...
	return (
		<div className={cn("relative", className)}>
			...
			<div
				className="group relative rounded-md p-3 ring-1 ring-ring backdrop-blur-lg shadow-lg"
			...
			>
				<img
					...
					width={1920}
					height={1080}
					className="w-full rounded-md border shadow-lg transition-all duration-200 ease-out"
				/>
